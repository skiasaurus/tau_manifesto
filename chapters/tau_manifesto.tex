...
binoclards du plus haut niveau\ns ; par exemple, au «\nsjour de pi\ns » en 2010,
...
à des formules succinctes et élégantes tout au long des mathématiques\ns ; par
...
d'Euler}, parfois appelée «\nsla plus belle équation en mathématiques\ns ». Cette
...
théorème ou prise comme définition\ns ; de toute façon, c'est assez remarquable~:
\begin{equation}
...
$\pi$, parfois appelés les «\nscinq nombres les plus importants en
mathématiques\ns ».
...
l'on prononce «\nsl'intégrale de zéro à té de gé té prime dé té prime\ns »). Ces
...
radians\ns » semble maladroit et «\nsla superficie d'un cercle est de demi-tour $r$
au carré\ns » sonne carrément bizarre. En utilisant $\tau$, on peut dire «\nstau
sur quatre radians\ns » et «\nsla superficie d'un cercle est de demi tau $r$ au
carré\ns ».
...
cercle et une «\nsquantité conjuguée de mouvement\ns » sur la même page
...
«\nsLa somme des angles intérieurs [d'un triangle] est $\pi$, c'est vrai. Mais la
...
et l'appelle «\nsclairement\textellipsis{} une autre victoire pour $\pi$\ns ». Mais
...
vous dire que «\nspratiquement toute de la section 5 [maintenant supprimée] est
