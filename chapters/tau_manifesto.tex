...
hauteur $r$. L'application de la formule de la superficie triangulaire nous donne
alors
\[
...
superficie circulaire, la manipulation qui laisse un $\pi$ simple est une
coïncidence.
...
possibles des formules de superficie et de volume sphériques (et sont en fait les
...
sont les plus simples quand elles sont posées en termes d'angle droit $\lambda$. Néanmoins, on n'en a
...
avant que ce soit cool} écrit en fait la récurrence en termes de $2\pi$\ns; la
