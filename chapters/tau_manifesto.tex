...
It should be obvious that $\pi$ is not ``wrong'' in the sense of being factually incorrect; the number $\pi$ is perfectly well-defined, and it has all the properties normally ascribed to it by mathematicians. When we say that ``$\pi$ is wrong'', we mean that \emph{$\pi$ is a confusing and unnatural choice for the circle constant}.
***Infinitely many shapes with constant diameter Figure~\ref{fig:bicycle_constant_diameters}
In particular, since a circle is defined as the set of points a fixed distance---the \emph{radius}---from a given point, a more natural definition for the circle constant uses $r$ in place of $D$:
\[
...
\begin{figure}
\imagebox{images/figures/bicycle_constant_diameters.png}
...
\[ e^{i\tau} = 1 + 0. \]
(In fact, since $i\sin\tau = 0$, the $0$ was already there.) This formula, \emph{without} rearrangement, actually does relate the five most important numbers in mathematics: $0$, $1$, $e$, $i$, and $\tau$.
...
\]
But this equality is a coincidence: it occurs only because $2^{n-1}$ happens to equal $n$ when $n=2$. In all higher dimensions, $n$ and $2^{n-1}$ are distinct. In other words, \emph{the geometric significance of $\pi$ is the result of a mathematical pun}.
...
%   \item The fundamental constant of $n$-spheres is $\eta = \tau/4$.
% \end{itemize}

% I find the last fact especially incredible. It shows that, while $\tau$ is the most natural \emph{circle} constant, it arguably derives its importance from the underlying $n$-sphere constant~$\eta$.
...
% The situation is similar with $\eta$ and $\tau$. When discussing $n$-spheres in general, $\eta$ leads to the most concise formulas, but in any particular dimension $\tau_n$ has a special significance as the (generalized) radian angle measure of the full $n$-sphere. The smallest nontrivial $n$-sphere---i.e., a circle---is of particular importance, and hence so is its associated constant $\tau_2 = 2^2\,\eta \equiv \tau$. Writing formulas involving circles in terms of $\eta$ would introduce numerous factors of~$4$.
...
\emph{The Tau Manifesto} author \href{http://www.michaelhartl.com/}{Michael Hartl} is a physicist, educator, and entrepreneur. He is the author of the \href{http://ruby.railstutorial.org/}{Ruby on Rails Tutorial}, the leading introduction to web development with \href{http://www.rubyonrails.org/}{Ruby on Rails}. Previously, he taught theoretical and computational physics at  \href{http://www.caltech.edu/}{Caltech}, where he received the Lifetime Achievement Award for Excellence in Teaching and served as Caltech's editor for \href{http://www.amazon.com/Feynman-Lectures-Physics-including-Feynmans/dp/0805390456/ref=sr_1_1?ie=UTF8&qid=1288414565&sr=8-1}{\emph{The Feynman Lectures on Physics: The Definitive and Extended Edition}}. He is a graduate of \href{http://college.harvard.edu/}{Harvard College}, has a \href{http://thesis.library.caltech.edu/1940/}{Ph.D. in Physics} from the \href{http://www.caltech.edu/}{California Institute of Technology}, and is an alumnus of the \href{http://ycombinator.com/}{Y~Combinator} entrepreneur program.

Michael is ashamed to admit that he knows $\pi$ to 50 decimal places---\href{\#fig:futurama_video}{approximately 48 more than Matt Groening}. To atone for this, he has now memorized \href{http://www.wolframalpha.com/input/?i=N[2+Pi,+53]}{52 decimal places} of $\tau$.

    \subsubsection{Copyright and license} % (fold)
    \label{sec:copyright_and_license}

\emph{The Tau Manifesto}. Copyright \copyright\ 2013 by Michael Hartl. Please feel free to share \emph{The Tau Manifesto}, which is available under the \href{http://creativecommons.org/licenses/by/3.0/}{Creative Commons Attribution 3.0 Unported License}. This means that you can adapt it, translate it, or even include it in commercial works, as long as you attribute it to me (Michael Hartl) and link back to tauday.com. You also have permission to distribute copies of \href{http://tauday.com/pdf}{\emph{The Tau Manifesto} PDF}, print it out, use it in classrooms, and so on. \emph{Go forth and spread the good news about~$\tau$!}
