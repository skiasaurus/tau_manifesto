...
\]
  ...
  \subsection{Une appréhension} % (fold)
  \label{sec:a_sense_of_foreboding}

Après avoir vu plusieurs exemples de formes quadratiques simples en physique, vous
avez maintenant peut-être un sentiment nerveux en retournant à la géométrie du
