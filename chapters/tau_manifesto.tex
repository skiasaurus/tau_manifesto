...
\href{https://tauday.com/le-manifeste-de-tau}{\emph{Le Manifeste de tau}} est dédié
...
trois quarts de période (figure~\ref{fig:cosine_with_tau}). Pour information, les deux figures montrent la valeur de $\theta$ (en radians) à chaque point spécial.
...
Dans ce contexte, il convient de remarquer que Le Manifeste de pi fait toute une
...
exotiques mais cependant élémentaires. Le
...
Lorsque l'on mentionne les sphères générales à $n$ dimensions, pour des raisons de
...
\begin{itemize}
  ...
  qui ont loupé la vraie constante du cercle sont parmi les personnes les plus
