...
tour\ns », et il introduit aussi un nouveau symbole pour la réprésenter (
...
le bon choix, et l'on montrera par l'usage (sections~\ref{sec:the_number_tau}
et~\ref{sec:circular_area}) et par l'argumentation directe (
