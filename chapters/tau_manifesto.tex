...
Ça devrait être évident que $\pi$ n'est pas «\ns mauvais\ns » dans le sens où il
...
le présenter à un large public. Il appelle la vraie constante du cercle «\ns un
tour\ns », et il introduit aussi un nouveau symbole pour le réprésenter (la
...
binoclards du plus haut niveau\,; par exemple, au «\ns jour de pi\ns » en 2010,
...
responsable du \href{https://cs.appstate.edu/~sjg/futurama/}{«\ns \emph{Futurama}
Math Page\ns »}.}\,?
...
$\tau/2$ est parfois appelé «\ns $\pi$\ns »}. Peut-être que cela vient de vous
...
d'Euler}, parfois appelée «\ns la plus belle équation en mathématiques\ns ». Cette
...
«\ns $\pi$ Is Wrong!\ns », Bob Palais, en 2010\,; John Fisher a proposé $\tau$ dans
un
...
«\ns intérieur\ns » comme un point\,\footnote{Cela a du sens, car un point n'a pas
...
récurrence\ns » n'est pas un hasard---la constante de récurrence et la constante
