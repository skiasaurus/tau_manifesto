...
sont au plus simple quand elles sont posées en termes d'angle droit $\lambda$. Néanmoins, on n'en a
...
\begin{itemize}
  ...
  mathématiques, et je suis surpris qu'Archimède, qui \href{https://translate.google.com/translate?hl=en&sl=en&tl=fr&u=http://itech.fgcu.edu/faculty/clindsey/mhf4404/archimedes/archimedes.html}{a
  ...
  $\tau$\nbh tologie, c'est la vraie nature du $\tau$. En contemplant cette nature
  pour chercher le \href{https://fr.wikipedia.org/wiki/Tao_(culture)}{chemin} du
  $\tau$, il faut nous rappeler que le $\tau$\nbh isme est basé sur la raison, pas
  sur la foi~: les $\tau$-istes ne sont jamais $\pi$\nbh eux. Et si vous n'êtes
  toujours pas convaincu, demandez-vous~: Pourquoi traîner les $\pi$\nbh eds, quand
  vous pouvez prendre le $\tau$\nbh reau par les cornes\ns ?
...
% Si jamais on s'entend dire des choses comme «\ns Parfois $\pi$ est le meilleur choix, et parfois c'est $2\pi$\ns », on devrait s'arrêter et se souvenir des paroles de \href{https://translate.google.com/translate?hl=en&sl=en&tl=fr&u=http://vihart.com/}{Vi Hart} dans sa magnifique \href{https://www.youtube.com/watch?v=jG7vhMMXagQ}{vidéo sur $\tau$}~: «\ns Non\ns! Vous cherchez des excuses pour $\pi$.\ns » Il est temps d'arrêter de chercher des excuses.
...
(via l'application pour iPhone de temps-en-$\tau$ et
