% href-pic-1: achetez l'e-book et les videos
% href-pic-2: décrochez un $\tau$-shirt
% banner: Voyez les mises à jour : l'état du Tau 2020
...
\section{La superficie du cercle~: le coup de grâce} % (fold)
...
\]
  ...
  \subsection{Un sentiment d'appréhension} % (fold)
...
Soit dit en passant, les pédants de $\pi$ (et il s'est avéré qu'il y en a beaucoup) pourraient
...
Dans ce contexte, il convient de noter que Le Manifeste de pi fait toute une
...
\section{Faire la lumière sur pi et tau} % (fold)
...
Plutôt que de simplement prendre ces formules pour argent comptant,
...
Ainsi, dans l'équation~\eqref{eq:volume_recurrence} comme
...
\begin{figure}
\begin{center}
\image{images/figures/Nspheres_fr.png}
\end{center}
...
Et l'on est enfin en mesure de comprendre exactement ce qui ne va pas avec $\pi$. La
...
% Si jamais vous vous entendez dire quelque chose comme «\ns Parfois $\pi$ est le meilleur choix, et parfois c'est $2\pi$\ns », vous devriez arrêter et vous souvenir des paroles de \href{https://translate.google.com/translate?hl=en&sl=en&tl=fr&u=http://vihart.com/}{Vi Hart} dans sa magnifique \href{https://www.youtube.com/watch?v=jG7vhMMXagQ}{vidéo sur $\tau$}~: «\ns Non\ns! Vous cherchez des excuses pour $\pi$.\ns » Il est temps d'arrêter de chercher des excuses.
...
% subheader: Partagez le Manifeste de $\tau$
% subsubheader: Rejoignez la liste de diffusion pour recevoir des nouvelles et des mises à jour
...
Feynman}}. Il est diplômé de \href{https://college.harvard.edu/}{Harvard}, il
a un \href{https://translate.google.com/translate?hl=en&sl=en&tl=fr&u=https://thesis.library.caltech.edu/1940/}{doctorat
en
...
$\tau$.
	...
	disponibles à l'achat sur \href{https://sales.tauday.com/}{le site de vente en ligne
  du \emph{Manifeste de tau}}.
    ...
    % subsubsection copyright_and_license (end)
        ...
        % href-1: le Manifeste de $\tau$
        % href-2: l'état du $\tau$
	% href-3: \]10^5\[ décimales de $\tau$
	% href-4: une parabole
	% href-5: les présentations de $\tau$

	% href-pic-1: achetez l'e-book et les videos
	% href-pic-2: décrochez un $\tau$-shirt

	% subheader: rejoignez la liste de diffusion pour recevoir des nouvelles et des mises à jour
	% input: Adresse E-mail
	% button: inscrivez-vous
