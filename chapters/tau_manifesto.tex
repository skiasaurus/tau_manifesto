...
\caption{Une forme non circulaires à largeur
...
une grande conspiration, vieille de plusieurs siècles, déterminée a propager
...
\end{tabular}
\end{center}
\caption{Identités eulériennes pour les rotations d'un quart, d'un demi et
