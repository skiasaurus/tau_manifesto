...
\end{table}
    ...
    \subsubsection{Ce qu'il fallait démontrer} % (fold)
...
le dernier, le meilleur argument en faveur de $\pi$, je vais ici être
effronté et dire~:
\href{https://fr.wikipedia.org/wiki/CQFD_(math%C3%A9matiques)}{C.Q.F.D.}.
