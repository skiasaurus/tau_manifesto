...
If you arrived here as a $\pi$ believer, you must by now be questioning your faith. $\tau$ seems so natural, its meaning so transparent---is there no example where $\pi$ shines through in all its radiant glory? A memory stirs---yes, there is such a formula---it is the formula for circular area! Behold:
