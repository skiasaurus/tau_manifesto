...
\noindent There are many more examples,\footnote{See ``$\pi$ Is Wrong!'' for a list of other formulas involving $2\pi$. Or just start browsing Wikipedia math pages. :-)} and the lesson is clear: there's something seemingly special about $2\pi$.
...
Inspired by the impressive success of ``$\pi$ Day'', the \emph{Tau Manifesto} launched on the morning of June 28, 2010: $\tau$ Day. This is a day for celebrating and rejoicing in all things mathematical and true. (Indeed, 6/28 is a \emph{perfect} day---for 6 and 28 are the first two \href{http://en.wikipedia.org/wiki/Perfect_number}{\emph{perfect numbers}}.) If you would like to receive updates about $\tau$, including notifications about possible future $\tau$ Day events, please join the \emph{Tau Manifesto} mailing list below.
