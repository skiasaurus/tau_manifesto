...
The first argument is weak, but it is a necessary prerequisite. The second argument is strong: after centuries of use, the association of $\pi$ with the circle constant is unavoidable, and $\tau$ feeds on this association rather than fighting it. The third argument is the clincher---looking at the first letter of that Greek lathe, I'm going to have to whip out my Latin again and say again:  \href{http://en.wikipedia.org/wiki/Q.E.D.}{\emph{quod erat demonstrandum}}.
