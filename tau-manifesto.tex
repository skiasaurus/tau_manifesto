...
\]
and in the values of the \href{http://en.wikipedia.org/wiki/Riemann_zeta_function}{Riemann zeta function} evaluated at even integers:
% (written in terms of the $n$th \href{http://en.wikipedia.org/wiki/Bernoulli_number}{Bernoulli number}):
