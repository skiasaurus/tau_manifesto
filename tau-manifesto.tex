...
\emph{It is time to let $\pi$ go.} I loved $\pi$ once; I really did. Today, although I bear it no ill will, I can no longer pretend that it deserves special recognition. It is true that $\pi$'s threads are woven throughout the fabric of mathematics, but for \emph{historical} reasons, not for logical ones. $\pi$ is not one of the most important numbers in mathematics; it is one half of one of the most important numbers. The mathematical significance of $\pi$ is that it is one-half $\tau$.
