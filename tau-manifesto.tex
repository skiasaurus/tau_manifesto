...
As seen in \hyperref[fig:circular-area]{Figure~}\ref{fig:circular-area}, the area of a circle can be calculated by breaking it down into circular rings of length $C$ and width $dr$:
...
\noindent The area of the circle in the integral over all the rings:
...
\begin{itemize}
  ...
  \item \textbf{Are you serious?} \\ Of course. I mean, I'm having fun with this, and the tone is mostly lighthearted, but there is a serious undercurrent. Although their obstinacy on this issue is truly remarkable, the mathematicians can mostly take care of themselves, but (as noted in \hyperref[sec:the_nature_of_angle]{Section~}\ref{sec:the_nature_of_angle}) $\pi$ is pedagogically pathetic. Try explaining to a twelve-year-old why the angle measure for an eighth of a circle is $\pi$/8. Wait---I meant $\pi$/4. See what I mean? It's madness---sheer, unadulterated madness.
